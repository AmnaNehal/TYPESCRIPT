...
var BankAccount = /** @class */ (function () {
    ...
    BankAccount.prototype.deposit = function (amount) {
        if (amount > 100) {
            amount -= 1; // 41 fee charged if more than $100 deposited
        }
        this.balance += amount;
...
//Create Customers 
var customers = [
    new Customer("Amna", "Nehal", "Female", 20, 11668699456, accounts[0]),
    new Customer("Kinza", "Akhtar", "Female", 20, 88674522280, accounts[1]),
    new Customer("Hassaan", "Mushtaq", "Male", 20, 99229992342, accounts[2])
];
